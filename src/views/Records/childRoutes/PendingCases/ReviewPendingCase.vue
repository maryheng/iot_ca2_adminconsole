  ...
  <div id="addOffenceContainer">
    ...
    <div class="box">
      ...
      <div class="backToCriminals">
        <router-link to="/records/pendingcases">
            ...
            <div id="resolveBtn">
              <div class="field is-horizontal">
                ...
                <div class="field-body">
                  <div class="field">
                    <div class="control">
                      <button class="button is-primary" :disabled="isDisabled" @click="resolveBtn">
                        Resolved
                      </button>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    resolveBtn () {
      axios.put(casesUrl + this.caseId + resolveCase)
        .then((response) => {
          this.isDisabled = true
          let closeFn = () => {
            router.push({ path: '/records/pendingcases' })
          }
          let successAlert = {
            title: 'Success',
